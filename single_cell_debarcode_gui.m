...
%%%%%%% begin edits KF 3/20/2017 %%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% change starting values of sep cutoff to 0 and mahal cutoff to max

set(handles.delta_text,'string','0')
% handles.obj.sep_cutoff=0.3; %now in obj

set(handles.mahal_cutoff,'string','Max')
...
if pathname ~= 0 %didn't hit cancel   
    ...
    %%%%%%%%KF edits 3/20/17%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%% adjusted code so after the fcs files are read in, the max mahal
    %%%%% distance is put into the mahal field that the user sees
    set(handles.mahal_cutoff,'string',handles.obj.mahal_cutoff_val) 
    %%% end KF edits %%%
    drawnow
...
%%%% KF edits 3/21/2017 %%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% update the new highest mahal value based off of the new separation
% distance
set(handles.mahal_cutoff,'string',handles.obj.mahal_cutoff_val)
%%%%%% end KF edits %%%%%%%%%%%%
